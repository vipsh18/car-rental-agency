...
<head>
	...
	<title>Car Rental Agency &#8226; Agency Login</title>
		...
		<div class="form-div text-center">
			...
			<form action="" method="POST" class="login-form">
				<div class="form-floating mb-3">
					...
					<label for="userEmail">Agency email address</label>
				</div>
				<div class="form-floating mb-3">
				...
				<input type="hidden" value="agency" name="loginType">

				<button class="btn btn-primary" type="submit">Login</button> <hr>
				<a href="./renter-login.php" role="button" class="btn btn-info">Login as Renter</a>
			</form>
		</div>
	</main>
